                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {canEdit && (
                        <button
                          ...
                          className="text-xs bg-neutral-600 text-white font-semibold py-1.5 px-3 rounded hover:bg-neutral-700 transition"
                        >
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl">
            ...
            <form onSubmit={handleMaintenanceSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="submit"
                  className="flex-1 bg-neutral-600 text-white py-2 rounded-lg hover:bg-neutral-700 font-bold transition shadow-sm"
                >
                  {t('confirm_usage')}
                </button>
                <button
