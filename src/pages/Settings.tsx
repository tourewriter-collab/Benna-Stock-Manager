            ...
            {diagLoading ? (
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  disabled={isRepairing}
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-neutral-600 text-white rounded-md hover:bg-neutral-700 disabled:opacity-50 transition-colors"
                >
